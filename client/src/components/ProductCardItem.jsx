  ...
  return (
    ...
    >
      <div className="relative flex h-56 items-center justify-center overflow-hidden bg-gray-100 dark:bg-gray-700 sm:h-64">
        {product.badge && (
          <motion.span
            className="absolute top-3 left-3 z-10 rounded bg-racing-red-500 px-2 py-0.5 text-xs font-semibold text-white"
            whileHover={{ y: -2 }}
          >
            {product.badge}
          </motion.span>
      ...
      >
        <div className="flex items-center justify-between">
          <h3 className="text-base font-bold text-gray-900 dark:text-white sm:text-lg">{product.name}</h3>
