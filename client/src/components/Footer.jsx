  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-4 pt-16 pb-8 sm:px-6 lg:px-8 lg:pt-24">
        ...
        <motion.div
          className="mt-16 border-t border-gray-100 dark:border-gray-700 pt-8 sm:flex sm:items-center sm:justify-between lg:mt-24"
          variants={{
        ...
        >
          ...
          <ul className="mt-8 flex justify-center gap-6 sm:mt-0 lg:justify-end">
            <li>
              <a href="#" rel="noreferrer" target="_blank" className="text-gray-700 dark:text-gray-300 transition hover:opacity-75">
