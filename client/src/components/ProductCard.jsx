    ...
    <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
      {products.map((product) => (
        <motion.a
          key={product.id}
          href="#"
          className="group block rounded-lg p-4 shadow-xs shadow-racing-red-100/50"
          whileHover={{
            y: -6,
          ...
          <div className="mt-3">
            <dl>
              ...
              <div>
                ...
                <dd className="mt-1 font-medium text-gray-900 group-hover:text-racing-red-600 transition-colors">
                  {product.name}
                </dd>
              </div>
            </dl>
            ...
            <div className="mt-5 flex items-center gap-4 text-xs">
              ...
              <div className="sm:inline-flex sm:shrink-0 sm:items-center sm:gap-1.5">
                ...
                <div>
                  ...
                  <p className="font-medium text-gray-700">30 days</p>
                </div>
              </div>
            </div>
